...
public interface AuditLogService {
     ...
     */
    Mono<AuditLogDTO> updateAuditLog(Long auditLogId, AuditLogDTO auditLogDTO);
     ...
     */
    Mono<Void> deleteAuditLog(Long auditLogId);
     ...
     */
    Mono<AuditLogDTO> getAuditLogById(Long auditLogId);
}